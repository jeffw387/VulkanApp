...
private:
    ...
    struct inner_node : public node
    {
		...
		using alloc_type = typename std::allocator_traits<_Alloc>::template rebind_alloc<inner_node>;
    ...
    struct leaf_node : public node
    {
		...
		using alloc_type = typename std::allocator_traits<_Alloc>::template rebind_alloc<leaf_node>;
...
private:
    ...
    inline void free_node(node *n)
    {
        if (n->isleafnode()) {
            ...
            //a.destroy(ln);
			std::allocator_traits<typename leaf_node::alloc_type>::destroy(a, ln);
            a.deallocate(ln, 1);
            m_stats.leaves--;
        }
        else {
			...
			std::allocator_traits<typename inner_node::alloc_type>::destroy(a, in);
            //a.destroy(in);
            a.deallocate(in, 1);
            m_stats.innernodes--;
        }
