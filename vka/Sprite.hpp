...
static Quad MakeQuad(float left, float top, float right, float bottom,
                     float leftUV, float topUV, float rightUV, float bottomUV) {
  Quad quad;
...
static Quad CreateQuad(float left, float top, float width, float height,
