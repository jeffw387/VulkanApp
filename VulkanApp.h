...
public:
	...
	void LoadFont(Text::FontID fontID, Text::FontSize fontSize, uint32_t DPI, const char* fontPath)
	{
		...
		auto newFaceError = FT_New_Face(m_TextEngine.m_FreeTypeLibrary, fontPath, 0, &fontData.face);
	...
	TextGroup createTextGroup(ECS::Manager& manager, SpriteMap& spriteMap, const InitInfo& initInfo)
	{
		TextGroup textGroup;
