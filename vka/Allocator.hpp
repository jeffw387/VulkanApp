...
struct MemoryBlock {
  ...
  std::optional<VkDeviceSize> CanAllocate(
      const VkMemoryRequirements& requirements);
  VkDeviceSize DivideAllocation(const VkDeviceSize allocationOffset,
                                const VkMemoryRequirements& requirements);
...
class Allocator {
 public:
  ...
  std::optional<uint32_t> ChooseMemoryType(
      VkMemoryPropertyFlags memoryFlags,
      const VkMemoryRequirements& requirements);
  AllocationHandle AllocateMemory(const bool DedicatedAllocation,
                                  const VkMemoryRequirements& requirements,
                                  const VkMemoryPropertyFlags memoryFlags);
  AllocationHandle AllocateForImage(const bool DedicatedAllocation,
                                    const VkImage image,
                                    const VkMemoryPropertyFlags memoryFlags);
  AllocationHandle AllocateForBuffer(const bool DedicatedAllocation,
